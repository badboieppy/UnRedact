...
use crate::data::redactions_data::{PdfFileRetriever, RedactionDataRetriever as _};
use crate::logic::{run_guess_from_bytes, RunGuessFromBytesRequest};
...
pub struct ToolingPdfRenderer {
    renderer: crate::dependency::hayro_renderer::HayroRenderer,
}

impl ToolingPdfRenderer {
    #[inline]
    pub fn new_from_bytes(pdf_bytes: &[u8]) -> Result<Self, String> {
        let renderer = crate::dependency::hayro_renderer::HayroRenderer::new_from_bytes(pdf_bytes)?;
        Ok(Self { renderer })
    }
