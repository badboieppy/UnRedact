...
fn build_anchor_record_from_row(row: &GuessCandidateRow) -> AnchorDecisionRecord {
    build_anchor_record(AnchorRecordInput {
        ...
        usable_right_edge_x_pt: row.anchor_set.geometry.usable_right_edge_x_pt,
        target_width_pt: row.anchor_set.geometry.target_width_pt,
        measurement_seed_side: row
            .anchor_set
            .measurement_seed_side
            .map(|side| side.as_str()),
        selected_line_id: row.anchor_set.selected_line_id.as_deref(),
        selection_reason: row.anchor_set.selection_reason.as_deref(),
        selected_left_gap_pt: row.anchor_set.selected_left_gap_pt,
        selected_right_gap_pt: row.anchor_set.selected_right_gap_pt,
...
struct AnchorRecordInput<'a> {
    ...
    target_width_pt: f32,
    measurement_seed_side: Option<&'a str>,
    selected_line_id: Option<&'a str>,
...
fn build_anchor_record(input: AnchorRecordInput<'_>) -> AnchorDecisionRecord {
    AnchorDecisionRecord {
        ...
        measurement_seed_side: input.measurement_seed_side.map(str::to_owned),
        selected_line_id: input.selected_line_id.map(str::to_owned),
        selection_reason: input.selection_reason.map(str::to_owned),
        selected_left_gap_pt: input.selected_left_gap_pt,
        selected_right_gap_pt: input.selected_right_gap_pt,
