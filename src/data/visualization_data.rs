...
mod tests {
        ...
        GuessReport {
            ...
            guesses: vec![RedactionGuess {
                ...
                candidates: vec![GuessCandidate {
                    ...
                    adjusted_error_pt: Some(0.0_f32),
                    noncanonical_penalty_pt: Some(0.0_f32),
                    provenance: None,
            ...
            anchors: vec![AnchorDecisionRecord {
                ...
                usable_right_edge_x_pt: Some(190.0_f32),
                target_width_pt: 110.0_f32,
                measurement_seed_side: Some("left".to_owned()),
                selected_line_id: Some("page0_line000".to_owned()),
                selection_reason: Some("pair_candidate_selected".to_owned()),
                selected_left_gap_pt: Some(4.0_f32),
                selected_right_gap_pt: Some(4.0_f32),
    ...
    fn sample_multi_anchor_pair_guesses() -> GuessReport {
        ...
        second.candidates = vec![GuessCandidate {
            ...
            char_spacing_total_pt: 0.0_f32,
            word_spacing_total_pt: 0.0_f32,
            adjusted_error_pt: Some(0.1_f32),
            noncanonical_penalty_pt: Some(0.0_f32),
            provenance: None,
